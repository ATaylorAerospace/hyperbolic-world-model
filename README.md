...
[![Tests](https://img.shields.io/badge/tests-329%20passing-brightgreen)](#-verification)
...
> 🚧 **Status:** Geometry primitives stable · V-JEPA 2-AC head training · 329/329 tests passing.
...
| `models/encoders/vjepa2.py` | V-JEPA 2-AC via torch.hub | Loads `vjepa2_ac_vit_giant` code from hub and Meta's `vjepa2-ac-vitg.pt` from the official URL; encodes each frame as Meta's inference code does (2-frame tubelet, layer-normed tokens); returns patch and pooled embeddings; `assert_frozen` on encoder and reference predictor; refuses partially loaded checkpoints; not yet run on real weights (needs `timm` on the loading machine) | 🚧 |
...
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-0.5)-f64] PASSED [ 17%]
...
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[euclidean-f32] PASSED [ 24%]
...
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[lorentz(c=-0.5)-f32] PASSED [ 27%]
...
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-1)-f64] PASSED [ 31%]
...
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[poincare(c=-0.5)-f64] PASSED [ 34%]
...
tests/geometry/test_base.py::test_ptransp_is_identity_at_the_same_point_and_reverses_the_geodesic[euclidean-f64] PASSED [ 37%]
...
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[euclidean-f32] PASSED [ 41%]
...
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-0.5)-f32] PASSED [ 44%]
...
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-2)-f32] PASSED [ 47%]
...
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-1)-f64] PASSED [ 48%]
...
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[lorentz(c=-0.5)] PASSED [ 51%]
...
tests/geometry/test_base.py::test_outputs_keep_input_dtype[euclidean-f64] PASSED [ 54%]
...
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-0.5)-f32] PASSED [ 55%]
...
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-0.5)-f64] PASSED [ 57%]
...
tests/geometry/test_euclidean.py::test_construction_and_curvature PASSED [ 58%]
...
tests/geometry/test_lorentz.py::test_minkowski_inner_and_inner[f64] PASSED [ 61%]
...
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f32--2.0] PASSED [ 62%]
...
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f32--0.5] PASSED [ 64%]
...
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f64--0.5] PASSED [ 65%]
...
tests/geometry/test_lorentz.py::test_gradients_match_finite_differences[-1.0] PASSED [ 67%]
...
tests/geometry/test_lorentz.py::test_float32_vs_float64_at_the_image_of_0999_radius[-1.0] PASSED [ 68%]
...
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f64--2.0] PASSED [ 71%]
...
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f32--0.5] PASSED [ 74%]
...
tests/models/test_vjepa2.py::test_loader_uses_torch_hub_entry_and_freezes_everything PASSED [ 96%]
