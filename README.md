[![hyperbolic-world-model](docs/header.png)](https://github.com/ATaylorAerospace/hyperbolic-world-model)

# 🌀 hyperbolic-world-model - Hyperbolic Latent Evaluation for World Models 📐
...
├── LICENSE                            # Apache 2.0, © 2026 Sandton AI
