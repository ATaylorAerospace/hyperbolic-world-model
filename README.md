...
[![Tests](https://img.shields.io/badge/tests-271%20passing-brightgreen)](#-verification)
...
> 🚧 **Status:** Geometry primitives stable · V-JEPA 2-AC head training · 271/271 tests passing.
...
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[euclidean] PASSED [  0%]
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[poincare(c=-1)] PASSED [  1%]
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[poincare(c=-0.5)] PASSED [  1%]
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[poincare(c=-2)] PASSED [  1%]
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[lorentz(c=-1)] PASSED [  2%]
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[lorentz(c=-0.5)] PASSED [  2%]
tests/geometry/test_base.py::test_curvature_name_offset_and_repr[lorentz(c=-2)] PASSED [  2%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[euclidean-f32] PASSED [  3%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[euclidean-f64] PASSED [  3%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[poincare(c=-1)-f32] PASSED [  4%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[poincare(c=-1)-f64] PASSED [  4%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[poincare(c=-0.5)-f32] PASSED [  4%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[poincare(c=-0.5)-f64] PASSED [  5%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[poincare(c=-2)-f32] PASSED [  5%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[poincare(c=-2)-f64] PASSED [  5%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[lorentz(c=-1)-f32] PASSED [  6%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[lorentz(c=-1)-f64] PASSED [  6%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[lorentz(c=-0.5)-f32] PASSED [  7%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[lorentz(c=-0.5)-f64] PASSED [  7%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[lorentz(c=-2)-f32] PASSED [  7%]
tests/geometry/test_base.py::test_expmap_logmap_are_inverse[lorentz(c=-2)-f64] PASSED [  8%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[euclidean-f32] PASSED [  8%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[euclidean-f64] PASSED [  8%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[poincare(c=-1)-f32] PASSED [  9%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[poincare(c=-1)-f64] PASSED [  9%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[poincare(c=-0.5)-f32] PASSED [  9%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[poincare(c=-0.5)-f64] PASSED [ 10%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[poincare(c=-2)-f32] PASSED [ 10%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[poincare(c=-2)-f64] PASSED [ 11%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[lorentz(c=-1)-f32] PASSED [ 11%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[lorentz(c=-1)-f64] PASSED [ 11%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[lorentz(c=-0.5)-f32] PASSED [ 12%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[lorentz(c=-0.5)-f64] PASSED [ 12%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[lorentz(c=-2)-f32] PASSED [ 12%]
tests/geometry/test_base.py::test_distance_is_a_metric_on_random_points[lorentz(c=-2)-f64] PASSED [ 13%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[euclidean-f32] PASSED [ 13%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[euclidean-f64] PASSED [ 14%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-1)-f32] PASSED [ 14%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-1)-f64] PASSED [ 14%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-0.5)-f32] PASSED [ 15%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-0.5)-f64] PASSED [ 15%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-2)-f32] PASSED [ 15%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[poincare(c=-2)-f64] PASSED [ 16%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[lorentz(c=-1)-f32] PASSED [ 16%]
tests/geometry/test_base.py::test_sqdist_dist0_and_pairwise_are_consistent_with_dist[lorentz(c=-1)-f64] PASSED [ 16%]
...
tests/geometry/test_base.py::test_origin_closed_forms_match_general_maps[euclidean-f64] PASSED [ 19%]
tests/geometry/test_base.py::test_origin_closed_forms_match_general_maps[poincare(c=-1)-f32] PASSED [ 19%]
...
tests/geometry/test_base.py::test_origin_closed_forms_match_general_maps[poincare(c=-0.5)-f64] PASSED [ 20%]
...
tests/geometry/test_base.py::test_origin_closed_forms_match_general_maps[lorentz(c=-1)-f32] PASSED [ 21%]
...
tests/geometry/test_base.py::test_origin_closed_forms_match_general_maps[lorentz(c=-0.5)-f64] PASSED [ 22%]
...
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[poincare(c=-1)-f64] PASSED [ 25%]
...
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[poincare(c=-2)-f32] PASSED [ 26%]
...
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[lorentz(c=-1)-f64] PASSED [ 27%]
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[lorentz(c=-0.5)-f32] PASSED [ 27%]
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[lorentz(c=-0.5)-f64] PASSED [ 28%]
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[lorentz(c=-2)-f32] PASSED [ 28%]
tests/geometry/test_base.py::test_geodesic_endpoints_and_midpoint[lorentz(c=-2)-f64] PASSED [ 28%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[euclidean-f32] PASSED [ 29%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[euclidean-f64] PASSED [ 29%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[poincare(c=-1)-f32] PASSED [ 29%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[poincare(c=-1)-f64] PASSED [ 30%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[poincare(c=-0.5)-f32] PASSED [ 30%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[poincare(c=-0.5)-f64] PASSED [ 30%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[poincare(c=-2)-f32] PASSED [ 31%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[poincare(c=-2)-f64] PASSED [ 31%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-1)-f32] PASSED [ 32%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-1)-f64] PASSED [ 32%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-0.5)-f32] PASSED [ 32%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-0.5)-f64] PASSED [ 33%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-2)-f32] PASSED [ 33%]
tests/geometry/test_base.py::test_proj_is_idempotent_and_returns_points_on_the_manifold[lorentz(c=-2)-f64] PASSED [ 33%]
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[euclidean-f32] PASSED [ 34%]
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[euclidean-f64] PASSED [ 34%]
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[poincare(c=-1)-f32] PASSED [ 35%]
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[poincare(c=-1)-f64] PASSED [ 35%]
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[poincare(c=-0.5)-f32] PASSED [ 35%]
...
tests/geometry/test_base.py::test_proj_tan_is_idempotent_and_logmap_is_tangent[poincare(c=-2)-f64] PASSED [ 36%]
...
tests/geometry/test_base.py::test_ptransp_is_identity_at_the_same_point_and_reverses_the_geodesic[lorentz(c=-0.5)-f32] PASSED [ 43%]
...
tests/geometry/test_base.py::test_ptransp_is_identity_at_the_same_point_and_reverses_the_geodesic[lorentz(c=-2)-f64] PASSED [ 44%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[euclidean-f32] PASSED [ 44%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[euclidean-f64] PASSED [ 45%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[poincare(c=-1)-f32] PASSED [ 45%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[poincare(c=-1)-f64] PASSED [ 45%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[poincare(c=-0.5)-f32] PASSED [ 46%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[poincare(c=-0.5)-f64] PASSED [ 46%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[poincare(c=-2)-f32] PASSED [ 46%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[poincare(c=-2)-f64] PASSED [ 47%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-1)-f32] PASSED [ 47%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-1)-f64] PASSED [ 47%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-0.5)-f32] PASSED [ 48%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-0.5)-f64] PASSED [ 48%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-2)-f32] PASSED [ 49%]
tests/geometry/test_base.py::test_egrad2rgrad_is_tangent_and_matches_geoopt[lorentz(c=-2)-f64] PASSED [ 49%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[euclidean-f32] PASSED [ 49%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[euclidean-f64] PASSED [ 50%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-1)-f32] PASSED [ 50%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-1)-f64] PASSED [ 50%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-0.5)-f32] PASSED [ 51%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-0.5)-f64] PASSED [ 51%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-2)-f32] PASSED [ 52%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[poincare(c=-2)-f64] PASSED [ 52%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-1)-f32] PASSED [ 52%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-1)-f64] PASSED [ 53%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-0.5)-f32] PASSED [ 53%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-0.5)-f64] PASSED [ 53%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-2)-f32] PASSED [ 54%]
tests/geometry/test_base.py::test_tangent0_lift_round_trip[lorentz(c=-2)-f64] PASSED [ 54%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[euclidean] PASSED [ 54%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[poincare(c=-1)] PASSED [ 55%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[poincare(c=-0.5)] PASSED [ 55%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[poincare(c=-2)] PASSED [ 56%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[lorentz(c=-1)] PASSED [ 56%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[lorentz(c=-0.5)] PASSED [ 56%]
tests/geometry/test_base.py::test_to_geoopt_returns_a_matching_manifold[lorentz(c=-2)] PASSED [ 57%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[euclidean] PASSED [ 57%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[poincare(c=-1)] PASSED [ 57%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[poincare(c=-0.5)] PASSED [ 58%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[poincare(c=-2)] PASSED [ 58%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[lorentz(c=-1)] PASSED [ 59%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[lorentz(c=-0.5)] PASSED [ 59%]
tests/geometry/test_base.py::test_check_point_rejects_points_off_the_manifold[lorentz(c=-2)] PASSED [ 59%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[euclidean-f32] PASSED [ 60%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[euclidean-f64] PASSED [ 60%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-1)-f32] PASSED [ 60%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-1)-f64] PASSED [ 61%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-0.5)-f32] PASSED [ 61%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-0.5)-f64] PASSED [ 61%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-2)-f32] PASSED [ 62%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[poincare(c=-2)-f64] PASSED [ 62%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-1)-f32] PASSED [ 63%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-1)-f64] PASSED [ 63%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-0.5)-f32] PASSED [ 63%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-0.5)-f64] PASSED [ 64%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-2)-f32] PASSED [ 64%]
tests/geometry/test_base.py::test_outputs_keep_input_dtype[lorentz(c=-2)-f64] PASSED [ 64%]
tests/geometry/test_euclidean.py::test_construction_and_curvature PASSED [ 65%]
tests/geometry/test_euclidean.py::test_primitives_reduce_to_vector_arithmetic[f32] PASSED [ 65%]
tests/geometry/test_euclidean.py::test_primitives_reduce_to_vector_arithmetic[f64] PASSED [ 66%]
tests/geometry/test_euclidean.py::test_geodesic_pairwise_and_check_point PASSED [ 66%]
tests/geometry/test_euclidean.py::test_gradients_match_finite_differences PASSED [ 66%]
tests/geometry/test_euclidean.py::test_to_geoopt_and_repr PASSED         [ 67%]
tests/geometry/test_lorentz.py::test_construction_k_and_geoopt_parameter[-0.5] PASSED [ 67%]
tests/geometry/test_lorentz.py::test_construction_k_and_geoopt_parameter[-1.0] PASSED [ 67%]
tests/geometry/test_lorentz.py::test_construction_k_and_geoopt_parameter[-2.0] PASSED [ 68%]
tests/geometry/test_lorentz.py::test_minkowski_inner_and_inner[f32] PASSED [ 68%]
tests/geometry/test_lorentz.py::test_minkowski_inner_and_inner[f64] PASSED [ 69%]
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f32--0.5] PASSED [ 69%]
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f32--1.0] PASSED [ 69%]
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f32--2.0] PASSED [ 70%]
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f64--0.5] PASSED [ 70%]
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f64--1.0] PASSED [ 70%]
tests/geometry/test_lorentz.py::test_points_and_origin_lie_on_the_hyperboloid[f64--2.0] PASSED [ 71%]
tests/geometry/test_lorentz.py::test_logmap_is_tangent_and_dist_is_its_length[-0.5] PASSED [ 71%]
tests/geometry/test_lorentz.py::test_logmap_is_tangent_and_dist_is_its_length[-1.0] PASSED [ 71%]
tests/geometry/test_lorentz.py::test_logmap_is_tangent_and_dist_is_its_length[-2.0] PASSED [ 72%]
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f32--0.5] PASSED [ 72%]
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f32--1.0] PASSED [ 73%]
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f32--2.0] PASSED [ 73%]
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f64--0.5] PASSED [ 73%]
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f64--1.0] PASSED [ 74%]
tests/geometry/test_lorentz.py::test_own_ptransp_matches_geoopt_and_is_finite_at_coincident_points[f64--2.0] PASSED [ 74%]
tests/geometry/test_lorentz.py::test_isometry_to_poincare_ball[-0.5] PASSED [ 74%]
tests/geometry/test_lorentz.py::test_isometry_to_poincare_ball[-1.0] PASSED [ 75%]
tests/geometry/test_lorentz.py::test_isometry_to_poincare_ball[-2.0] PASSED [ 75%]
tests/geometry/test_lorentz.py::test_gradients_match_finite_differences[-0.5] PASSED [ 76%]
tests/geometry/test_lorentz.py::test_gradients_match_finite_differences[-1.0] PASSED [ 76%]
tests/geometry/test_lorentz.py::test_gradients_match_finite_differences[-2.0] PASSED [ 76%]
tests/geometry/test_lorentz.py::test_tangent_lift_and_euclidean_projection PASSED [ 77%]
tests/geometry/test_lorentz.py::test_float32_vs_float64_at_the_image_of_0999_radius[-1.0] PASSED [ 77%]
tests/geometry/test_lorentz.py::test_float32_vs_float64_at_the_image_of_0999_radius[-2.0] PASSED [ 77%]
tests/geometry/test_poincare.py::test_construction_radius_and_geoopt_parameter[-0.5] PASSED [ 78%]
tests/geometry/test_poincare.py::test_construction_radius_and_geoopt_parameter[-1.0] PASSED [ 78%]
tests/geometry/test_poincare.py::test_construction_radius_and_geoopt_parameter[-2.0] PASSED [ 78%]
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f32--0.5] PASSED [ 79%]
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f32--1.0] PASSED [ 79%]
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f32--2.0] PASSED [ 80%]
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f64--0.5] PASSED [ 80%]
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f64--1.0] PASSED [ 80%]
tests/geometry/test_poincare.py::test_lambda_x_closed_form[f64--2.0] PASSED [ 81%]
tests/geometry/test_poincare.py::test_mobius_add_identity_inverse_and_geoopt[f32--0.5] PASSED [ 81%]
tests/geometry/test_poincare.py::test_mobius_add_identity_inverse_and_geoopt[f32--1.0] PASSED [ 81%]
tests/geometry/test_poincare.py::test_mobius_add_identity_inverse_and_geoopt[f32--2.0] PASSED [ 82%]
tests/geometry/test_poincare.py::test_mobius_add_identity_inverse_and_geoopt[f64--0.5] PASSED [ 82%]
tests/geometry/test_poincare.py::test_mobius_add_identity_inverse_and_geoopt[f64--1.0] PASSED [ 83%]
tests/geometry/test_poincare.py::test_mobius_add_identity_inverse_and_geoopt[f64--2.0] PASSED [ 83%]
tests/geometry/test_poincare.py::test_gyration_is_an_isometry_and_trivial_at_zero[-0.5] PASSED [ 83%]
tests/geometry/test_poincare.py::test_gyration_is_an_isometry_and_trivial_at_zero[-1.0] PASSED [ 84%]
tests/geometry/test_poincare.py::test_gyration_is_an_isometry_and_trivial_at_zero[-2.0] PASSED [ 84%]
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f32--0.5] PASSED [ 84%]
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f32--1.0] PASSED [ 85%]
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f32--2.0] PASSED [ 85%]
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f64--0.5] PASSED [ 85%]
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f64--1.0] PASSED [ 86%]
tests/geometry/test_poincare.py::test_ptransp_preserves_conformal_norm[f64--2.0] PASSED [ 86%]
tests/geometry/test_poincare.py::test_distance_closed_form_from_origin PASSED [ 87%]
tests/geometry/test_poincare.py::test_gradients_match_finite_differences[-0.5] PASSED [ 87%]
tests/geometry/test_poincare.py::test_gradients_match_finite_differences[-1.0] PASSED [ 87%]
tests/geometry/test_poincare.py::test_gradients_match_finite_differences[-2.0] PASSED [ 88%]
tests/geometry/test_poincare.py::test_proj_clips_to_boundary[f32] PASSED [ 88%]
tests/geometry/test_poincare.py::test_proj_clips_to_boundary[f64] PASSED [ 88%]
tests/geometry/test_poincare.py::test_float32_vs_float64_at_0999_of_the_boundary_radius[-1.0] PASSED [ 89%]
tests/geometry/test_poincare.py::test_float32_vs_float64_at_0999_of_the_boundary_radius[-2.0] PASSED [ 89%]
tests/geometry/test_poincare.py::test_float32_round_trip_holds_inside_the_clip_margin[-1.0] PASSED [ 90%]
tests/geometry/test_poincare.py::test_float32_round_trip_holds_inside_the_clip_margin[-2.0] PASSED [ 90%]
tests/geometry/test_public_api.py::test_every_public_name_is_referenced_by_a_geometry_test PASSED [ 90%]
tests/geometry/test_public_api.py::test_public_api_is_non_trivial PASSED [ 91%]
tests/geometry/test_utils.py::test_eps_and_min_norm_tables PASSED        [ 91%]
tests/geometry/test_utils.py::test_artanh_matches_torch_inside_and_is_finite_at_the_boundary[f32] PASSED [ 91%]
tests/geometry/test_utils.py::test_artanh_matches_torch_inside_and_is_finite_at_the_boundary[f64] PASSED [ 92%]
tests/geometry/test_utils.py::test_arcosh_matches_torch_and_is_finite_at_one[f32] PASSED [ 92%]
tests/geometry/test_utils.py::test_arcosh_matches_torch_and_is_finite_at_one[f64] PASSED [ 92%]
tests/geometry/test_utils.py::test_safe_norm_never_returns_zero[f32] PASSED [ 93%]
tests/geometry/test_utils.py::test_safe_norm_never_returns_zero[f64] PASSED [ 93%]
tests/geometry/test_utils.py::test_clip_norm_only_shrinks[f32] PASSED    [ 94%]
tests/geometry/test_utils.py::test_clip_norm_only_shrinks[f64] PASSED    [ 94%]
tests/geometry/test_utils.py::test_helpers_keep_shape[artanh] PASSED     [ 94%]
tests/geometry/test_utils.py::test_helpers_keep_shape[arcosh] PASSED     [ 95%]
tests/metrics/test_distortion.py::test_perfect_embedding_has_zero_distortion_and_unit_map PASSED [ 95%]
tests/metrics/test_distortion.py::test_random_embedding_is_worse_than_structured PASSED [ 95%]
tests/metrics/test_distortion.py::test_shape_validation PASSED           [ 96%]
tests/metrics/test_gromov_hyperbolicity.py::test_tree_metric_has_zero_delta PASSED [ 96%]
tests/metrics/test_gromov_hyperbolicity.py::test_grid_has_positive_delta PASSED [ 97%]
tests/metrics/test_gromov_hyperbolicity.py::test_delta_is_scale_covariant PASSED [ 97%]
tests/metrics/test_gromov_hyperbolicity.py::test_subsampled_estimator_on_point_clouds PASSED [ 97%]
...
tests/test_smoke_experiment.py::test_smoke_runs_end_to_end[lorentz] PASSED [ 98%]
